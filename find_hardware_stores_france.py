#!/usr/bin/env python3
"""
Script to find hardware stores across France using Google Places API
"""
...
# Multiple France locations to search
FRANCE_LOCATIONS = [
...
print("Searching for hardware stores across France...")
print("=" * 60)
...
with open(summary_filename, 'w') as f:
    f.write("FRANCE HARDWARE STORES - FINAL SUMMARY\n")
    f.write("=" * 50 + "\n\n")
